...
name: release
description: >
  Coordinate a full Handrails release across engineering verification, npm,
...
Run the full Handrails maintainer release workflow, not just an npm publish.
...
7. If running through Handrails, you have issue context for status updates and follow-up task creation.
...
Handrails now uses a commit-driven release model:
...
npm view handrailsai@canary version
```
...
- release summary in Handrails issue context
