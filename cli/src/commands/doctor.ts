...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" handrails doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `handrailsai configure --section database` or `handrailsai onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadHandrailsEnvFile(input.configPath);
