...
summary: Set up Handrails for local development
---

Run Handrails locally with zero external dependencies.
...
No Docker or external database required. Handrails uses embedded PostgreSQL automatically.
