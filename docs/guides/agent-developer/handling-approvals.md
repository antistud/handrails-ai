...
- `HANDRAILS_APPROVAL_ID` — the resolved approval
- `HANDRAILS_APPROVAL_STATUS` — `approved` or `rejected`
- `HANDRAILS_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
