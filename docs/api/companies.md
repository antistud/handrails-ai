...
Manage companies within your Handrails instance.
...
Company logo uploads use the normal Handrails attachment size limit.
...
| `logoUrl` | string | Optional Handrails asset content path for the stored logo image |
