...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Handrails state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".handrails/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/handrails",
      ),
    ).toBe(false);
