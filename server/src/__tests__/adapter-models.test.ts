...
import { models as codexFallbackModels } from "@handrailsai/adapter-codex-local";
import { models as cursorFallbackModels } from "@handrailsai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@handrailsai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.HANDRAILS_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.HANDRAILS_OPENCODE_COMMAND = "__handrails_missing_opencode_command__";
