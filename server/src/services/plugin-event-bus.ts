/**
 * PluginEventBus — typed in-process event bus for the Handrails plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@handrailsai/shared";
import type { PluginEvent, EventFilter } from "@handrailsai/plugin-sdk";
