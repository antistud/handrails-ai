...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@handrailsai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: HandrailsPluginManifestV1, pluginDbId?: string): void;
