 ...
 */
import type { CompanyPortabilityManifest } from "@handrailsai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Handrails](https://handrails.ing)");
  lines.push("");
