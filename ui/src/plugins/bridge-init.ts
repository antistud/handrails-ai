 ...
 *
 * This is placed on `globalThis.__handrailsPluginBridge__` and consumed by
...
declare global {
  ...
  var __handrailsPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__handrailsPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__handrailsPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
