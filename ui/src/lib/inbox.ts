...
export const DISMISSED_KEY = "handrails:inbox:dismissed";
export const READ_ITEMS_KEY = "handrails:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "handrails:inbox:last-tab";
