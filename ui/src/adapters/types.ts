...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@handrailsai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@handrailsai/adapter-utils").TranscriptEntry[];
