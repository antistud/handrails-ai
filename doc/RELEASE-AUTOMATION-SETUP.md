...
This document covers the GitHub and npm setup required for the current Handrails release model:
...
Do this for every public package that Handrails publishes.
...
3. add a trusted publisher for the GitHub repository `handrailsai/handrails`
...
2. revoke any personal automation token that used to publish Handrails
