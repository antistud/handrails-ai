...
Low-level reference for how Handrails packages are prepared and published to npm.
...
Handrails no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `handrailsai`, imports code from workspace packages such as:
...
Handrails uses calendar versions:
...
- `handrailsai@2026.318.1-canary.2`
