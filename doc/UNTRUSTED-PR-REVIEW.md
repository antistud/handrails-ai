...
This is intentionally separate from the normal Handrails dev image.
...
```sh
review-checkout-pr handrailsai/handrails 432
cd /work/checkouts/handrailsai-handrails/pr-432
```
...
## Preview the Handrails app from the PR
...
- Handrails's embedded PostgreSQL and local storage stay inside the container home volume via `HANDRAILS_HOME=/home/reviewer/.handrails-review`.
