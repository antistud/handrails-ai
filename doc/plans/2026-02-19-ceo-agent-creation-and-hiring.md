...
- installed adapter list for this Handrails instance
...
## 8. New Skill: `handrails-create-agent`

Create new skill directory:

- `skills/handrails-create-agent/SKILL.md`
...
Also update `skills/handrails/SKILL.md` to reference this skill for hiring workflows.
...
- `handrails-create-agent` skill + docs updates
