...
- `skills/handrails/SKILL.md` and `skills/handrails/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/handrails-create-agent/SKILL.md`
