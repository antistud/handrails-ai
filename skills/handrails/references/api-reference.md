# Handrails API Reference

Detailed reference for the Handrails control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Handrails Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "handrails-mobile",
    "cwd": "/Users/me/handrails-mobile",
    "repoUrl": "https://github.com/acme/handrails-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `handrails-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
