...
Eval framework for testing Handrails agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Handrails heartbeat skill:
