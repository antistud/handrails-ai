...
import type { PluginCategory, PluginStatus, HandrailsPluginManifestV1 } from "@handrailsai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<HandrailsPluginManifestV1>().notNull(),
