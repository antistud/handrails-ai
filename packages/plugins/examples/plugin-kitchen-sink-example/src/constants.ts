import type { PluginLauncherRegistration } from "@handrailsai/plugin-sdk";

export const PLUGIN_ID = "handrails-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".handrails-kitchen-sink-demo.txt",
} as const;
