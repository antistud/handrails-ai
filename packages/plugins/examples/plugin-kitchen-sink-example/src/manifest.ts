...
const manifest: HandrailsPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Handrails plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Handrails",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Handrails domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
