/**
 * `definePlugin` — the top-level helper for authoring a Handrails plugin.
 *
...
// ---------------------------------------------------------------------------
// HandrailsPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface HandrailsPlugin {
 ...
 * @returns A sealed `HandrailsPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@handrailsai/plugin-sdk";
