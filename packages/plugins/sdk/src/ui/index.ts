/**
 * `@handrailsai/plugin-sdk/ui` — Handrails plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@handrailsai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@handrailsai/plugin-sdk/ui";
 *
