 ...
 *
 * These components are exported from `@handrailsai/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@handrailsai/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function HandrailsSdkUiComponent(props: TProps) {
