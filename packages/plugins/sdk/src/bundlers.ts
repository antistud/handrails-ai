/**
 * Bundling presets for Handrails plugins.
 *
 ...
 * to match the Handrails plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@handrailsai/plugin-sdk/ui",
    "@handrailsai/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@handrailsai/plugin-sdk"],
  };
