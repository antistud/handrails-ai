...
import type { HandrailsPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@handrailsai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: HandrailsPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@handrailsai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
