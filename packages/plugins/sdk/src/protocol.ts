 ...
 * channel.
 *
 * The Handrails plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@handrailsai/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Handrails messages.
 */
...
/**
 * Handrails plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Handrails instance. */
    instanceId: string;
    /** Semver version of the running Handrails host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
