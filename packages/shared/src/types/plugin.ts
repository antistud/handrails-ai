...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within HandrailsPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Handrails host.
 *
...
export interface HandrailsPluginManifestV1 {
   ...
   */
  minimumHandrailsVersion?: PluginMinimumHostVersion;
